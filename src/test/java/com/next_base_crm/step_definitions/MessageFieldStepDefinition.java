...
public class MessageFieldStepDefinition {
    ...
    public void user_clicks_on_the_button(String messageBtn) {
    ...
    @Then("the user type message into the message box")
    ...
    public void button_is_selected_by_default(String option) {
    ...
    public void the_user_clicks_the_cancel_button() {
        ...
        Driver.getDriver().switchTo().frame(Driver.getDriver().findElement(By.xpath("//iframe[@class='bx-editor-iframe']")));
        messagePage.inputMessage.sendKeys("Good morning great team");
